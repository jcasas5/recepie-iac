...
@minLength(3)
@maxLength(30)
param appServiceAppName1 string = 'jcasasus-assignment-be-pr'
@sys.description('The Web App name.')
@minLength(3)
@maxLength(30)
param appServiceAppName3 string = 'jcasasus-assignment-fe-pr'
@sys.description('The App Service Plan name.')
@minLength(3)
@maxLength(30)
param appServicePlanName1 string = 'jcasasus-assignment-pr'
@sys.description('The Web App name.')
@minLength(3)
@maxLength(30)
param appServiceAppName2 string = 'jcasasus-assignment-be-dv'
@minLength(3)
@maxLength(30)
param appServiceAppName4 string = 'jcasasus-assignment-fe-dv'
@sys.description('The App Service Plan name.')
@minLength(3)
@maxLength(30)
param appServicePlanName2 string = 'jcasasus-assignment-dv'
